...
function UsdcIcon({
  ...
  return (
    <svg
      ...
      x="0px"
      y="0px"
      viewBox="0 0 3095.1 2270.2"
      // style="enable-background:new 0 0 3095.1 2270.2;"
      // xml:space="preserve"
    >
      <style>
        {`
      ...
      <path
        className="st0"
        d="M1547.6,2135.1c554.2,0,1000-445.8,1000-1000s-445.8-1000-1000-1000s-1000,445.8-1000,1000
   S993.4,2135.1,1547.6,2135.1z"
      />
      <path
        className="st1"
        d="M1822.6,1293.4c0-145.8-87.5-195.8-262.5-216.7c-125-16.7-150-50-150-108.3s41.7-95.8,125-95.8
   ...
   h62.5c16.7,0,29.2-12.5,33.3-33.3v-100C1739.2,1493.4,1822.6,1405.9,1822.6,1293.4L1822.6,1293.4z"
      ...
      <path
        className="st1"
        d="M1335.1,1730.9c-325-116.7-491.7-479.2-370.8-800c62.5-175,200-308.3,370.8-370.8c16.7-8.3,25-20.8,25-41.7
